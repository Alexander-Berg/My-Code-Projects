...
// Type: Amplitude.Mercury.Interop.EditorOrderForceAlliance
...
{
  public class EditorOrderForceAlliance : EditorOrder
  {
    public int LeftEmpireIndex = -1;
    public int RightEmpireIndex = -1;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderForceAlliance;
