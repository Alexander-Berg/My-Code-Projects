...
// Type: Amplitude.Mercury.Interop.EditorOrderSetGodCityCap
...
{
  public class EditorOrderSetGodCityCap : EditorOrder
  {
    public int EmpireIndex = -1;
    public int CityCap;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderSetGodCityCap;

    public override void Pack(BinaryMemoryStream writer)
    {
      base.Pack(writer);
      writer.Write(this.EmpireIndex);
      writer.Write(this.CityCap);
    }
    ...
    public override void Unpack(BinaryMemoryStream reader)
    {
      ...
      this.CityCap = reader.ReadInt32();
    }

    public override void Serialize(Serializer serializer)
    {
      this.EmpireIndex = serializer.SerializeElement("EmpireIndex", this.EmpireIndex);
      this.CityCap = serializer.SerializeElement("CityCap", this.CityCap);
    }
