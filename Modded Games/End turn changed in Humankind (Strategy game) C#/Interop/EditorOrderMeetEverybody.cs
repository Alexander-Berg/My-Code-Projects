...
// Type: Amplitude.Mercury.Interop.EditorOrderMeetEverybody
...
{
  public class EditorOrderMeetEverybody : EditorOrder
  {
    public int EmpireIndex = -1;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderMeetEverybody;
