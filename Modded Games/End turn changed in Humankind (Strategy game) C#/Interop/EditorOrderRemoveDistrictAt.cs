...
// Type: Amplitude.Mercury.Interop.EditorOrderRemoveDistrictAt
...
{
  public class EditorOrderRemoveDistrictAt : EditorOrder
  {
    public int TileIndex;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderRemoveDistrictAt;
