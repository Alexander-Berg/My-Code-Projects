...
// Type: Amplitude.Mercury.Interop.EditorOrderCreateExtensionDistrictAt
...
{
  public class EditorOrderCreateExtensionDistrictAt : EditorOrder
  {
    public StaticString DistrictDefinitionName;
    public int TileIndex;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderCreateExtensionDistrictAt;

    public override void Pack(BinaryMemoryStream writer)
    {
      base.Pack(writer);
      writer.Write(this.DistrictDefinitionName.ToString());
    ...
    {
      base.Unpack(reader);
      this.DistrictDefinitionName = new StaticString(reader.ReadString());
      this.TileIndex = reader.ReadInt32();
    }

    public override void Serialize(Serializer serializer)
    {
      this.DistrictDefinitionName = serializer.SerializeElement<StaticString>("DistrictDefinitionName", this.DistrictDefinitionName);
