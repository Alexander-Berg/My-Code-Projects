...
// Type: Amplitude.Mercury.Interop.EditorOrderActivateCivic
...
{
  public class EditorOrderActivateCivic : EditorOrder
  {
    public int EmpireIndex = -1;
    public StaticString CivicName;
    public int ChoiceIndex;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderActivateCivic;
    ...
    public override void Unpack(BinaryMemoryStream reader)
    {
      ...
      this.ChoiceIndex = reader.ReadInt32();
    }
    ...
    public override void Serialize(Serializer serializer)
    {
      ...
      this.ChoiceIndex = serializer.SerializeElement("ChoiceIndex", this.ChoiceIndex);
    }
