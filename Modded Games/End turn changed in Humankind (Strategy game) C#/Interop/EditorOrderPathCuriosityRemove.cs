...
// Type: Amplitude.Mercury.Interop.EditorOrderPathCuriosityRemove
...
{
  public class EditorOrderPathCuriosityRemove : EditorOrder
  {
    public int TileIndex;

    public override OrderIdentifier OrderIdentifier => OrderIdentifier.EditorOrderPathCuriosityRemove;
